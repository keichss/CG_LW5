...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/phoenix_ugv.md2")) {
            return false;
        }

        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/jeep.obj")) {
            return false;
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/hheli.obj")) {
            return false;
        }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina Tutorial 32")) {
        return 1;
    }
