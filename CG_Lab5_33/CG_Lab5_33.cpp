...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh->LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/spider.obj")) {
            return false;
        }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina Tutorial 33")) {
        return 1;
    }
