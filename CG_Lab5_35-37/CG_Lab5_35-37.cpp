...
public:
    ...
    bool Init()
    {
        ...
        if (!m_quad.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/quad.obj")) {
            return false;
        }

        if (!m_box.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/box.obj")) {
            return false;
        }

        if (!m_bsphere.LoadMesh("C:/Users/ASUS/source/repos/CG_Lab5/Content/sphere.obj")) {
            return false;
        }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina Tutorial 37")) {
        return 1;
    }
